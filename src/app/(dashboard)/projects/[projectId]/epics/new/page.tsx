...
import { addepic } from "@/redux/features/epics/epic";
...
type ProjectFormData = z.infer<typeof epicSchema>;
...
export default function AddEpicPage() {
  ...
  data.assignee_id && data.assignee_id.trim() !== ""
    ...
    : null,
      ...
      console.log("Add epic error:", err);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <p className="text-sm mb-5 font-medium text-gray-500">PROJECTS &gt;<span className="text-primary"> ADD NEW PROJECT</span> </p>
            <h1 className="text-2xl font-semibold text-gray-900">Add New Epic</h1>
          </div>
