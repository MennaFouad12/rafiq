...
//       router.push("/projects"); // أو project page
...
//       <div className="">
// <p className="text-sm mb-5 font-medium mx-auto text-gray-600 bg-surface-highest px-4 w-fit  py-1 rounded-xl">New Project Invitation</p>
// <h3 className="font-bold text-xl mb-6 ">You've been invited to join new project</h3>
...
import InviteContent from "./_components/invite-page";
