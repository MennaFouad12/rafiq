...
//   viewer: "bg-gray-200 text-gray-500",
// };
...
// // Skeleton Row
// const SkeletonRow = () => (
//   <div className="grid grid-cols-4 items-center px-6 py-4 border-b animate-pulse">
...
//               {/* Member */}
//               <div className="flex items-center gap-3">
//                 <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-blue-100 text-blue-600 font-bold">
...
//                     roleStyles[member.role?.toLowerCase()] ||
