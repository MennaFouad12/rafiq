...
export default function Input({
  ...
  return (
    <div className={`flex flex-col gap-1 mt-6 ${className}`}>
      {label && (
        <div className="flex items-center justify-between mb-1.5">
          <label
      ...
      <div className="relative">
        ...
        {leftIcon && (
          <div
            className={`absolute inset-y-0 inset-s-0 flex items-center ps-3 pointer-events-none text-placeholder ${iconClassName}`}
          >
            {leftIcon}
          </div>
        )}
